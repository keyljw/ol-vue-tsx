<template>
  <o-map v-loading="loading" height="400px" :center="[120.171465, 30.250236]" :zoom="11">
    <o-layer :ol-style="style" @singleclick="onClick" @pointermove="onPointermove">
      <o-polygon
...
let style = (feature: Feature<Polygon>) => {
  let data = feature.get('data')
  let id = feature.getId()
  return {
    fill: { color: checkId.value === id ? 'rgba(255, 255, 255, 0.8)' : 'rgba(255, 255, 255, 0.2)' },
...
let onClick = ({ feature, event }: any) => {
  if (feature) {
    ElMessage.success('进入了图层')
